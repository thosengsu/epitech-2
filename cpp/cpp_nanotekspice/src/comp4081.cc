...
nts::comp4081::comp4081(const std::string& name)
  : AComponent(getTypeTab(), name)
{
  this->_gates[3] = new nts::andGate;
  this->_gates[4] = new nts::andGate;
  this->_gates[10] = new nts::andGate;
  this->_gates[11] = new nts::andGate;
}

nts::comp4081::~comp4081() {
}

void					nts::comp4081::linkGates()
{
  bool					state = false;
...
nts::Tristate				nts::comp4081::Compute(size_t pin_num_this)
{
  if (pin_num_this == 3)
    {
